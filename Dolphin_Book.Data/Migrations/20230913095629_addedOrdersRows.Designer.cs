...
namespace Dolphin_Book.Data.Migrations
{
    ...
    [Migration("20230913095629_addedOrdersRows")]
    partial class addedOrdersRows
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dolphin_Book.Core.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dolphin_Book.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dolphin_Book.Core.Entities.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dolphin_Book.Core.Entities.OrderItem", b =>
                {
                    b.HasOne("Dolphin_Book.Core.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Dolphin_Book.Core.Entities.OrderProduct", b =>
                {
                    b.HasOne("Dolphin_Book.Core.Entities.OrderItem", "OrderItem")
